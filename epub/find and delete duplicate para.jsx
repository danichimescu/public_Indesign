...

{
	...
	//for (var i = 0; i < myParagraphsCuprins.length; i++) {
		...
		// var searchPattern = "^([^ ]+) ([^ ]+) ([^ ]+) ([^ ]+) (.+)";
		// selecteaza un rand ^((.+)\\r)
		var searchPattern = "^((.+)\\r)\\1*\\2";

		app.findGrepPreferences.findWhat = searchPattern;
		//app.findGrepPreferences.findWhat = "^((.+)\r)\1*\2"; // ########
		//app.findGrepPreferences.justification = Justification.CENTER_ALIGN;
		//app.findGrepPreferences.fontStyle= 'Bold';

		app.changeGrepPreferences.changeTo =  "$2"; //\r
		//app.changeGrepPreferences.appliedParagraphStyle = "#Titlu";
		mystorydoiTextMare.changeGrep();
...
app.doScript("main()", u, u, UndoModes.ENTIRE_SCRIPT, "The Scriptul");
