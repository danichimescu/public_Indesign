...

{
	...
	function	changeTitlu1() 
		...
		function	changeTitlu3() 
		{
		//app.findGrepPreferences = app.changeGrepPreferences = NothingEnum.NOTHING;
		app.findGrepPreferences.findWhat = "";
		app.findGrepPreferences.appliedParagraphStyle = "#Titlu 3";
		app.changeGrepPreferences.changeTo =  ""; //\r
    ...
    // //app.findGrepPreferences = app.changeGrepPreferences = NothingEnum.NOTHING;
	// app.findGrepPreferences.findWhat = "";
	// app.findGrepPreferences.appliedParagraphStyle = "#Titlu 1";
	// app.changeGrepPreferences.changeTo =  ""; //\r
	// app.changeGrepPreferences.appliedParagraphStyle = "#Titlu 1";
	// mystorydoiTextMare.changeGrep();
