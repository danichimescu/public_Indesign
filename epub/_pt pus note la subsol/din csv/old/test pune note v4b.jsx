...
// try {
    ...
    for (b = 0; b < maxCounter_note; b++) {
        ...
        for (c = 0; c < toate_stories.length; c++) {
            ...
            try {
                // alert("c este " + c + " nr_nota " + nr_nota + " found  " + found_nr_nota_in_celelaltestory[0].contents)
            ...
            // }
            // for (k = toate_stories[0].paragraphs.length - 1; k >= 0; k--) {
            //     if (toate_stories[0].paragraphs[k].contents.search(nr_nota) == 0) { //if (story.paragraphs[k].contents.search(/^\[\d+\]/) == 0) {
            //         currPara = toate_stories[0].paragraphs[k].move(LocationOptions.AT_BEGINNING, mEndNotes.parentStory);
            //         currPara.words[0].remove();
            //     }
            // }
        }
