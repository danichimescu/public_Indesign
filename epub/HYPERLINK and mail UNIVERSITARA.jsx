...
function Main() {
	...
	var mEpubPublisher = "Universitara";// OK
...
try{
	if (mEpubPublisher=="Universitara"){
		my_urlforinput = "https://www.editurauniversitara.ro"
		my_emailforinput = "mailto:redactia@editurauniversitara.ro" // mailto:kenw@leadingswmaniacs.com
		}
